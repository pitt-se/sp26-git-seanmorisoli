public class CommitCafe {
    ...
    public static void brew(String drink) {
        ...
        System.out.println("[BOT CHECK] drink length = " + drink.length()); System.out.println("[BOT CHECK] drink length = " + drink.length()); System.out.println("[BOT CHECK] drink length = " + drink.length()); // STUDENT_TODO_2B: Add a second brew-related improvement
    }
